...
class AppToolbarView @JvmOverloads constructor(
    ...
    init {
        val a = context.obtainStyledAttributes(attrs, R.styleable.CrownToolbarView, defStyleAttr, 0/*defStyleRes*/)
        try {
            val title = (a.getString(R.styleable.CrownToolbarView_title))
            val rightButton = (a.getString(R.styleable.CrownToolbarView_rightButton))
            val navIcon = (a.getDrawable(R.styleable.CrownToolbarView_navIcon))
            val theme = (a.getInt(R.styleable.CrownToolbarView_themeType, 0))
